...
/* Define to 1 if you have module dune-graphene1 available */
#define HAVE_DUNE_GRAPHENE1 1
...
/* begin private */
/* Name of package */
#define PACKAGE "dune-graphene1"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "a@."

/* Define to the full name of this package. */
#define PACKAGE_NAME "dune-graphene1"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "dune-graphene1 1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "dune-graphene1"
...
/* Define to the version of dune-graphene1 */
#define DUNE_GRAPHENE1_VERSION "1"

/* Define to the major version of dune-graphene1 */
#define DUNE_GRAPHENE1_VERSION_MAJOR 1

/* Define to the minor version of dune-graphene1 */
#define DUNE_GRAPHENE1_VERSION_MINOR 1

/* Define to the revision of dune-graphene1 */
#define DUNE_GRAPHENE1_VERSION_REVISION 1
