...
/* begin private */
/* Name of package */
#define PACKAGE "dune-nanowire"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "a@."

/* Define to the full name of this package. */
#define PACKAGE_NAME "dune-nanowire"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "dune-nanowire 1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "dune-nanowire"
...
#define DUNE_NANOWIRE_VERSION "1"

/* Define to the major version of dune-nanowire */
#define DUNE_NANOWIRE_VERSION_MAJOR 1

/* Define to the minor version of dune-nanowire */
#define DUNE_NANOWIRE_VERSION_MINOR 1

/* Define to the revision of dune-nanowire */
#define DUNE_NANOWIRE_VERSION_REVISION 1
