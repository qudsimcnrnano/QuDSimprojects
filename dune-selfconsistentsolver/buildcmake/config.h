...
/* Define to 1 if you have module dune-sc1 available */
#define HAVE_DUNE_SC1 1
...
/* begin private */
/* Name of package */
#define PACKAGE "dune-sc1"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "@."

/* Define to the full name of this package. */
#define PACKAGE_NAME "dune-sc1"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "dune-sc1 1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "dune-sc1"
...
/* Define to the version of dune-sc1 */
#define DUNE_SC1_VERSION "1"

/* Define to the major version of dune-sc1 */
#define DUNE_SC1_VERSION_MAJOR 1

/* Define to the minor version of dune-sc1 */
#define DUNE_SC1_VERSION_MINOR 1

/* Define to the revision of dune-sc1 */
#define DUNE_SC1_VERSION_REVISION 1
