...
/* Define to 1 if you have module dune-p3d available */
#define HAVE_DUNE_P3D 1
...
/* begin private */
/* Name of package */
#define PACKAGE "dune-p3d"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "a@."

/* Define to the full name of this package. */
#define PACKAGE_NAME "dune-p3d"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "dune-p3d 1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "dune-p3d"
...
/* Define to the version of dune-p3d */
#define DUNE_P3D_VERSION "1"

/* Define to the major version of dune-p3d */
#define DUNE_P3D_VERSION_MAJOR 1

/* Define to the minor version of dune-p3d */
#define DUNE_P3D_VERSION_MINOR 1

/* Define to the revision of dune-p3d */
#define DUNE_P3D_VERSION_REVISION 1
